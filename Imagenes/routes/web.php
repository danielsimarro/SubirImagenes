...
//Route::post('imagen/{imagen}', [ImagenController::class, 'upload'])->name('imagen.upload');
Route::get('trabajador/{trabajador}/imagen', [TrabajadorController::class, 'imagen'])->name('trabajador.imagen');

Route::post('trabajador/{trabajador}/upload', [TrabajadorController::class, 'upload'])->name('trabajador.upload');